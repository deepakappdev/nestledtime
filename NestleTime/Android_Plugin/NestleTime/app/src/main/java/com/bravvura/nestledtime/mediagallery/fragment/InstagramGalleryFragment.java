...
import com.bravvura.nestledtime.mediagallery.adapter.InstagramMediaGalleryAdapter;
...
public class InstagramGalleryFragment extends BaseFragment {
    private TabLayout tabLayout;
    private ViewPager viewPager;
    private InstagramMediaGalleryAdapter adapter;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_media_instagram_pager, container, false);
    }
    ...
    private void initComponent(View view) {
        adapter = new InstagramMediaGalleryAdapter(getChildFragmentManager(), this);
