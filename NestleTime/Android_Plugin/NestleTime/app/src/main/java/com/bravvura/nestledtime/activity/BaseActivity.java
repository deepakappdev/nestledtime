...
import com.bravvura.nestledtime.worlds.ui.fragment.MyWorldsFragment;
import com.bravvura.nestledtime.worlds.ui.fragment.WorldDetailFragment;
...
//    }
    ...
    Fragment getFragment(FRAGMENTS fragmentId) {
        ...
        switch (fragmentId) {
            case WORLD_DETAIL:
                fragment = new WorldDetailFragment();
                break;
            case MY_WORLDS:
                fragment = new MyWorldsFragment();
                break;
            case FACEBOOK_ALBUM:
