...
public class FacebookAlbumGalleryAdapter extends RecyclerView.Adapter<FacebookAlbumGalleryAdapter.MediaViewHolder> {
    private ArrayList<MediaModel> mediaModels;
    private final int cellWidth;
    private MediaElementClick albumClickListener;

    public FacebookAlbumGalleryAdapter(ArrayList<MediaModel> mediaModels, int width) {
    ...
    class MediaViewHolder extends RecyclerView.ViewHolder {
        ...
        public void populate(MediaModel mediaModel) {
            ...
            Glide.with(itemView.getContext()).load(mediaModel.thumbnail).into(imageItem);
